...
@section('content')
    <div class="row">
        ...
        <div class="col-lg-4 col-xlg-3 col-md-5">
            <div class="card">
                <div class="card-body">
                    <center class="m-t-30"> <img src="{{ Storage::url($reg->avatar) }}" class="rounded-circle"
                            width="150" />
        ...
        <div class="col-lg-8 col-xlg-9 col-md-7">
            <div class="card">
                ...
                <ul class="nav nav-pills custom-pills" id="pills-tab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" id="pills-profile-tab" href="#profile-tab" data-toggle="pill" role="tab"
                            aria-controls="pills-profile" aria-selected="false">Personal Data</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="pills-profile-file" href="#profile-file" data-toggle="pill" role="tab"
                            aria-controls="pills-file" aria-selected="false">Personal File</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="pills-setting-tab" href="#setting-tab" data-toggle="pill" role="tab"
                            aria-controls="pills-setting" aria-selected="false">Academic Value</a>
                    </li>
                </ul>
                <!-- Tabs -->
                    ...
                    <div class="tab-pane fade show active" id="profile-tab" role="tabpanel"
                        ...
                        <div class="card-body">
                            ...
                            <form method="POST" action="{{ route('admin.registrant.update', $reg->id) }}">
                                    ...
                                    <div class="col-xl-12 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="name" class="form-control required"
                                                placeholder="Nama Siswa" value="{{ $reg->name }}">
                                            <i class="icon-user"></i>
                                        </div>
                                    </div>
                                    <div class="col-xl-4 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="place_birth" class="form-control required"
                                                placeholder="Tempat Lahir" value="{{ $reg->place_birth }}">
                                            <i class="icon-user"></i>
                                        </div>
                                    </div>
                                    <div class="col-xl-4 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="date_birth" class="form-control required"
                                                placeholder="Tanggal Lahir" value="{{ $reg->date_birth }}">
                                            <i class="icon-user"></i>
                                        </div>
                                    </div>
                                    <div class="col-xl-4 col-md-6">
                                        ...
                                        <div class="form-group input-group">
                                            <select class="form-control custom-select required" name="gender">
                                                ...
                                                <option value="L" {{ $reg->gender == 'L' ? 'selected' : '' }}>Laki Laki
                                                </option>
                                                <option value="P" {{ $reg->gender == 'P' ? 'selected' : '' }}>Perempuan
                                                </option>
                                            </select>
                                            <!-- <i class="icon-user"></i> -->
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="region" class="form-control required"
                                                placeholder="Agama" value="{{ $reg->region }}">
                                            <i class="icon-user"></i>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-xl-6 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="parent_name" class="form-control required"
                                                placeholder="Nama Orang Tua" value="{{ $reg->parent_name }}">
                                            <i class="icon-user"></i>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group input-group">
                                            ...
                                            <input type="text" name="parent_phone" class="form-control"
                                                ...
                                                aria-describedby="basic-addon1" value="{{ $reg->parent_phone }}">
                                        </div>
                                    </div>
                                    <div class="col-xl-12 col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="school_origin" class="form-control required"
                                                placeholder="Asal Sekolah" value="{{ $reg->school_origin }}">
                                            <i class="icon-user"></i>
                                        </div>
                                    </div>
                                    <div class="col-xl-12 col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="adress" class="form-control notes"
                                                placeholder="Alamat Anda">{{ $reg->adress }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-xl-12 col-md-12">
                                        <div class="form-group input-group">
                                            <select name="majors" class="form-control custom-select required">
                                                ...
                                                <option value="IPS" {{ $reg->majors == 'IPS' ? 'selected' : '' }}>IPS
                                                </option>
                                                <option value="IPA" {{ $reg->majors == 'IPA' ? 'selected' : '' }}>IPA
                                                </option>
                                            </select>
                                            <!-- <i class="icon-user"></i> -->
                                        </div>
                                    ...
                                    <div class="col-xl-12 col-md-12">
                                        <div class="form-group input-group">
                                            <select name="lane" class="form-control custom-select required">
                                                ...
                                                <option value="Regular" {{ $reg->lane == 'Regular' ? 'selected' : '' }}>
                                                    Regular</option>
                                                <option value="Unggulan"
                                                    {{ $reg->lane == 'Unggulan' ? 'selected' : '' }}>Unggulan</option>
                                            </select>
                                            <!-- <i class="icon-user"></i> -->
                                        </div>
                                    </div>
                                ...
                                <button type="submit"
                                    class="btn waves-effect waves-light btn-primary float-right mb-3">Update Now</button>
                            </form>
                        </div>
                    </div>
                    <div class="tab-pane fade show active" id="profile-file" role="tabpanel"
                        aria-labelledby="pills-profile-tab">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-12 b-r"> <strong>Scan File Semester 3</strong>
                                    <br>
                                    <a href="{{ Storage::url($reg->file_sm_1) }}" target="__blank">Klik Disini</a>
                                </div>

                                <div class="col-md-12 b-r"> <strong>Scan File Semester 4</strong>
                                    <br>
                                    <a href="{{ Storage::url($reg->file_sm_2) }}" target="__blank">Klik Disini</a>
                                </div>
                                ...
                                <div class="col-md-12"> <strong>Piagam / Penghargaan</strong>
                                    <br>
                                    <a href="{{ isset($reg->file_piagam) ? Storage::url($reg->file_piagam) : '#' }}"
                                        target="__blank">{{ isset($reg->file_piagam) ? 'Klik Disini' : 'Tidak ada file' }}</a>
                                </div>
                            </div>
                        </div>
                    </div>
