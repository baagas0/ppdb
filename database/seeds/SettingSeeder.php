...
class SettingSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Setting::create([
            'slug'         => 'regular-registration-date',
            'title'     => '',
            'content'     => '08-04-2022/08-04-2023',
            'file'         => '',
        ]);

        Setting::create([
            'slug'         => 'regular-test-date',
            'title'     => '',
            'content'     => '08-04-2022',
            'file'         => '',
        ]);
        ...
        Setting::create([
            'slug'         => 'regular-announcement-date',
            'title'     => '',
            'content'     => '08-04-2022',
            'file'         => '',
        ]);
        ...
        Setting::create([
            'slug'         => 'unggulan-registration-date',
            'title'     => '',
            'content'     => '08-05-2022/08-03-2023',
            'file'         => '',
        ]);
